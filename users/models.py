...
class Profile(models.Model):
    ...
    bio = models.TextField(blank=True, max_length=500)  # Optional biography field
    ...
    last_active = models.DateTimeField(auto_now=True)  # Updates every time the profile is saved
